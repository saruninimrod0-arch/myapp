...
const handleSubmit = async(e) =>{
  ...
  // Updste our loading hooks with message that will be displayed to the users who are trying to register
  ...
  try{
    ...
    // update the error hook with the massage given back from the response
